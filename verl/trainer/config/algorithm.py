...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        drop_zero_signal (bool): Drop GRPO groups whose rollouts all scored identically.
            Their advantages are exactly zero, so they add no gradient, but under
            loss_agg_mode token-mean their tokens still dilute the denominator, and they
            still cost an old_log_prob forward and an update_actor pass.
