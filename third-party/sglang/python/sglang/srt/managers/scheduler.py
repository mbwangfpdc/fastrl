...
class Scheduler(
    ...
    def __init__(
        ...
        # Init adpative speculative decoding
    ...
    def init_memory_pool_and_cache(self):
        ...
        self.decode_mem_cache_buf_multiplier = (
            ...
            if self.spec_algorithm.is_none()
                ...
                + ((server_args.speculative_eagle_topk or 1) * (server_args.speculative_num_steps or 1))
            )
        )
    ...
    def event_loop_normal(self):
        ...
        while True:
            ...
            if hasattr(self.draft_worker, "check_and_trigger_transition"):
                if self.draft_worker.check_and_trigger_transition():
                    ...
                    all_reqs = reqs_to_requeue + self.waiting_queue + self.grammar_queue
                    for req in all_reqs:
                        req.fill_ids = []
    ...
    def run_batch(
        ...
        # Set queue length for adaptive speculation
        batch.num_queue_req = len(self.waiting_queue)
    ...
    def flush_cache(self):
        ...
        if (
            ...
            if self.draft_worker:
                ...
                if self.draft_worker.adaptive_spec_threshold is not None:
                    self.draft_worker.reset_adaptive_spec_params()
